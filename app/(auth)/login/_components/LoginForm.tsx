...
import { Github, GithubIcon, Loader } from "lucide-react";
                        ...
                        className="w-full"
                         ...
                         {githubPending ? (
                            ...
                            <div className="relative text-center text-sm after:absolute
                             after:insert-0 after:top-1/2 after:z-0 after:flex after:items-center
                              af ter:border-t after:border-border">
